...
class SirahDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final idx = kSirahChapters.indexWhere((c) => c.number == chapterNumber);
    if (idx < 0) {
      final err = Center(child: Text('Chapter $chapterNumber tidak ditemukan.'));
      return chromeless
          ? err
